...
class Settings:
    ...
    LLAMA_SERVER_EXECUTABLE = os.getenv("LLAMA_SERVER_EXECUTABLE", "C:/llama/llama-server.exe")
    LLAMA_SERVER_MODEL_PATH = os.getenv("LLAMA_SERVER_MODEL_PATH","models/Llama-3.2-3B-Instruct-Q4_K_M.gguf")
    LLAMA_SERVER_WORKDIR = os.getenv("LLAMA_SERVER_WORKDIR","C:/llama")
    LLAMA_SERVER_HOST = os.getenv("LLAMA_SERVER_HOST","127.0.0.1")
    LLAMA_SERVER_PORT = os.getenv("LLAMA_SERVER_PORT", 8000)
